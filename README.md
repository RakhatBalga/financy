...
- `💼 Портфель` — позиции акций, текущие котировки Yahoo Finance и P/L в USD/KZT.
- `🏦 Депозиты` — остатки депозитов в KZT или USD.
- `🎯 Финцели` — цели, накопленная сумма и процент выполнения.
- `💰 Капитал` — общая стоимость акций и депозитов в KZT и USD.
